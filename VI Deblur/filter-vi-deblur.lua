...
source_def = {}
source_def.id = 'filter-vi-deblur'
...
function script_description()
	return "Adds a filter to downsample to half resolution then upsample back to the original.\nThis is mostly useful to remove the \"VI Blur\" from N64. \n\nBy Jademalo"
end



function reload_filter(filter)
    local effect_path = script_path() .. 'filter-vi-deblur/vi-deblur.effect'
